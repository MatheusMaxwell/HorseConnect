...
struct InseminationRegisterView: View {
    
    @Environment(\.dismiss) var dismiss
    @StateObject private var model = InseminationRegisterViewModel()
...
struct InseminationRegisterView_Previews: PreviewProvider {
    static var previews: some View {
        InseminationRegisterView()
    }
}
